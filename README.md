...
At first user should create `DbaaSClickhouseClient`. This is a base client, which allows working with tenant and service databases.
...
import (
	...
	clickhousedbaas "github.com/netcracker/qubership-core-lib-go-dbaas-clickhouse-client"
